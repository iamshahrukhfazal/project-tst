  ...
  return (
    <AdminBody>
      ...
      <div className=" flex flex-wrap">
       ...
       <div className="p-4">
          <h1 className="text-center text-2xl border-b-2 pb-2 mb-2">Add New Menu</h1>
        <div className=" flex space-x-2 items-center">
          <TextInput
            input={input}
            setInput={setInput}
          ...
          <div className="mt-4 w-full   ">
            <Button action={() => {}} title="Add New Menu"></Button>
          </div>
        </div>

        <div className="">
          <h1 className="text-center text-xl border-b-2 pb-2 mb-2">Assign Categories to Menu</h1>
